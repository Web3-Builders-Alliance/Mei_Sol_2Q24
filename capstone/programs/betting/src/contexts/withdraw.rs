...
impl<'info> Withdraw<'info> {
    pub fn Withdraw(&mut self) -> Result<()> {
       ...
       require!(self.market.resolved_as_yes.is_some(), BettingError::NotResolved);
       require!(self.market.resolved_as_yes.unwrap() == self.bet_state.is_yes, BettingError::NotTheWinner);
